...
int main(void)
{
 ...
 msp_printf("   singed long int = 0x%x bytes\r\n", sizeof(struct_var.LB));
 ...
 msp_printf("Dumping data values from the Union\r\n",0);
 msp_printf("---------------------------------------------------------\r\n",0);
 ...
 msp_printf(". union signed short int SA[0] = 0x%X\r\n", union_var.SA[0]);
 msp_printf("union unsigned short int SA[1] = 0x%X\r\n", union_var.SA[1]);
 msp_printf(". union signed short int SA[1] = 0x%X\r\n", union_var.SA[1]);
 msp_printf("\r\n",0);
